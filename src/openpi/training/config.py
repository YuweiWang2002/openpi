...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_aloha_robotwin_lift_pot",
        model=pi0_config.Pi0Config(pi05=True),
    ...
    TrainConfig(
        name="pi05_late_strong_sync_fixed005_aloha_robotwin_lift_pot",
        model=pi0_config.Pi0Config(
            pi05=True,
            late_strong_sync=True,
            late_strong_sync_action_dim=14,
            late_strong_sync_gate="fixed_scalar",
            late_strong_sync_gate_init=0.05,
        ),
        data=_robotwin_aloha_data(
            "lift_pot_expert",
            assets_dir="./assets/pi05_aloha_robotwin_lift_pot",
    ...
    TrainConfig(
        name="pi05_late_strong_sync_scalar005_aloha_robotwin_lift_pot",
        model=pi0_config.Pi0Config(
            pi05=True,
            late_strong_sync=True,
            late_strong_sync_action_dim=14,
            late_strong_sync_gate="learnable_scalar",
            late_strong_sync_gate_init=0.05,
        ),
        data=_robotwin_aloha_data(
            "lift_pot_expert",
    ...
    TrainConfig(
        name="pi05_late_strong_sync_perdim005_aloha_robotwin_lift_pot",
        model=pi0_config.Pi0Config(
            pi05=True,
            late_strong_sync=True,
            late_strong_sync_action_dim=14,
            late_strong_sync_gate="per_dim",
            late_strong_sync_gate_init=0.05,
        ),
        data=_robotwin_aloha_data(
            "lift_pot_expert",
    ...
    TrainConfig(
        name="pi05_late_strong_sync_fixed005_aloha_robotwin_handover_mic",
        model=pi0_config.Pi0Config(
            pi05=True,
            late_strong_sync=True,
            late_strong_sync_action_dim=14,
    ...
    TrainConfig(
        name="pi05_late_strong_sync_scalar005_aloha_robotwin_handover_mic",
        model=pi0_config.Pi0Config(
            pi05=True,
            late_strong_sync=True,
            late_strong_sync_action_dim=14,
    ...
    TrainConfig(
        name="pi05_late_strong_sync_perdim005_aloha_robotwin_handover_mic",
        model=pi0_config.Pi0Config(
            pi05=True,
            late_strong_sync=True,
            late_strong_sync_action_dim=14,
